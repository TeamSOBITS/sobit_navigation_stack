...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(get_package_share_directory('sobits_mapping'), 'map', 'hsr_map.yaml'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'param', 'hsr', 'navigation_config.yaml'),
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            Node(
                ...
                remappings=remappings + [('/hsrb/command_velocity', 'cmd_vel_nav')]),
            Node(
            ...
            Node(
                ...
                arguments=['--ros-args', '--log-level', log_level],
                remappings=remappings +
                        [('/hsrb/command_velocity', 'cmd_vel_nav'), ('cmd_vel_smoothed', '/hsrb/command_velocity')]),
            Node(
