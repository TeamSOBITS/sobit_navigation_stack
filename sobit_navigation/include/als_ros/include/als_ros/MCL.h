...
public:
    ...
    void broadcastTF(void) {
        ...
        //poseOnMap：map上のロボットの位置をパラメータから取得
        ...
        // std::cout << "poseOnMap : x = " << poseOnMap.position.x << std::endl;
        tf2::Transform map2baseTrans;
        //map2baseTrans：map上からbase_footprintを取得
        ...
        if (useOdomTF_) {
            ...
            // mapからodomに変換しているはずだが、ここがうまく言っていない可能性がある
