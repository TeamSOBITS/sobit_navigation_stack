...
def pantilt_controll():
    args = sys.argv
    mini_joint_ctr = SobitMiniJointController(args[0]) # args[0] : C++上でros::init()を行うための引数
    ...
    mini_joint_ctr.moveHeadPanTilt( pan_ang, tilt_ang, 2.0 )

if __name__ == '__main__':
    try:
        rospy.init_node('sobit_mini_pantilt_controll')
        pantilt_controll()
